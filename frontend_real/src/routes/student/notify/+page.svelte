...
<div>
  <ul class="list bg-base-100 rounded-box shadow-md">
    ...
    <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">系统通知信息</li>
    
    <li class="list-row">
      <div class="text-4xl font-thin opacity-30 tabular-nums">01</div>
      <div class="list-col-grow">
        <div class="text-xl">系统维护预告</div>
        <div class="text-xs uppercase font-semibold opacity-60">由系统发布</div>
      </div>
...
<div>
<ul class="list bg-base-100 rounded-box shadow-md m-21">
